...
public class FlippingAnImageTest {
    ...
    @Test
    public void flipAndInvertImage_flip_horizontally() {
        int[][] input = new int[4][4];
        input[0][0] = 1;
        input[0][1] = 1;
        input[0][2] = 0;
        ...
        new FlippingAnImage().flipHorizontally(input);

        assertTrue(Arrays.deepEquals(expected, input));
    }

    @Test
    public void flipAndInvertImage_invert() {
        int[][] input = new int[4][4];
        input[0][0] = 1;
        input[0][1] = 1;
        input[0][2] = 0;
        ...
        new FlippingAnImage().invert(input);
