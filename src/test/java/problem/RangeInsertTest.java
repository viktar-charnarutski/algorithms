...
public class RangeInsertTest {
    ...
    public void insertRange2() {
        ...
        ArrayList<Interval> expected = new ArrayList<>();
        expected.add(new Interval(0, 1));
        expected.add(new Interval(2, 3));
        expected.add(new Interval(4, 5));
    ...
    public void insertRange5() {
        ...
        expected.add(new Interval(12, 14));
    ...
    public void insertRange6() {
        ...
        ArrayList<Interval> expected = new ArrayList<>();
        expected.add(new Interval(-10, -5));
        expected.add(new Interval(-2, -1));
        expected.add(new Interval(0, 10));
    ...
    public void insertInterval2() {
        ...
        ArrayList<Interval> expected = new ArrayList<>();
        expected.add(new Interval(-1, 0));
        expected.add(new Interval(0, 1));
        expected.add(new Interval(3, 4));
        RangeInsert.insertInterval(input, new Interval(-1, 0));

        assertEquals(expected, input);
    }

    @Test
    public void insertInterval3() {
        ArrayList<Interval> input = new ArrayList<>();
        input.add(new Interval(0, 1));
        input.add(new Interval(3, 4));
        ...
        RangeInsert.insertInterval(input, new Interval(5, 6));
